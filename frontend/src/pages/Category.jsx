...
function CategoryListPage() {
    ...
    const rightToolbarTemplate = () => (
        <Button
            ...
            onClick={() => navigate('/categorias/nova')} // Rota para nova categoria
        />
    );
        ...
        <div>
            ...
            <Card>
                ...
                <DataTable
                    ...
                    dataKey="id"
                >
                    <Column field="id" header="ID" sortable style={{ maxWidth: '8rem' }}></Column>
                    <Column field="name" header="Nome" sortable style={{ minWidth: '12rem' }}></Column>
                    <Column field="obs" header="Observação" style={{ minWidth: '16rem' }}></Column>
